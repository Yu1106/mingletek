...
$loginInformation->id = '103336381140338';
$loginInformation->email = 'lziqovbybc_1574304011@tfbnw.net';
$loginInformation->name = 'Sandra Aldciaibhggjh Adeagbostein';
$login = new Login($loginInformation);
$login->login();
