        ...
        <form id="uploadMajor" method="post" action="step3.php">
            ...
            <section class="sectionUpload">
                ...
                <label class="sectionDesc noticeTxt">請上傳商品圖片(可傳多張)，系統會為您匹配圖片，並產出商品介紹；如果沒有附圖可直接按下一步。<br/>照片長或寬的解析度不可小於600
                    ...
                    <div id="terms" class="fancybox-content lightBox">
                        ...
                        <p>上架小幫手（網址為WWW.MINGLETEK.COM，以下稱「本網站」）為鼎洋智能科技股份有限公司（以下稱「本公司」）所經營之電子商務平台
                            ...
                            (包含但不限於尚未註冊為會員之一般使用者，及已註冊為會員之品牌或行銷夥伴，以下稱「會員」、「您」)相關服務。</p>
                        <ol>
                            <li>一、同意條款
                                <ol>
                                    <li>1.
                                    ...
                                    <li>3.
                                        若您於本條款進行任何修改或變更之後，仍繼續使用本網站、本服務，將視為您已經閱讀、瞭解且同意接受相關修改及變更。若您不同意全部或部分者，則請勿使用本網站、本服務。
                                    </li>
                                    <li>4. 若您尚未滿十八
                            ...
                            <li>二、會員帳號、密碼及安全
                                <ol>
                                    ...
                                    <li>3. 除經證明係第三人違法使用之情形，您須為利用您所設定之正確帳號、密碼登入之使用行為負全部責任，不得任意否認於本平台上所提供之任何資訊或交易。</li>
                                    <li>4. 您聲明並保證您所填寫之基本資料為您正確且完整的資料，不得使用他人資料、如有違反前開保證，本公司有權暫停或終止您的帳號，並拒絕您使用本網站的服務。</li>
                                    <li>5.
                            ...
                            <li>四、服務說明
                                <ol>
                                    <li>1. 本網站為提供產生大量上架用文件之服務，會員於完成線上免費註冊程序、並通過本公司審核後，得使用本平台的完整服務。</li>
                                    ...
                                    <li>4.
                                        會員若連續180天未登入本平台使用本服務時，本公司有權暫停您的使用權，並有權清除您於本平台儲存之所有資料。有無登入使用本平台之紀錄，以本公司系統內所留存之紀錄為準。
                                    </li>
                                    <li>5. 您同意本公司可以向您註冊時所使用的電子信箱發送本平台、本服務之公告或商業訊息。</li>
                                </ol>
                            </li>
                            <li>五、會員上傳資料分享
                                <ol>
                                    <li>
                                        您同意於本網站、本服務上傳發佈之內容預設為公開予所有第三人觀看，並同意本公司得公開展示於本服務的相關系統網路上，包括但不限於本網站的搜尋服務，或本公司所舉辦的行銷活動上。相關內容並得被公開張貼及與他人分享。
                                    </li>
                                </ol>
                            </li>
                            <li>六、智慧財產權
                                <ol>
                                    <li>1. 會員透過本網站、本服務所上傳之圖檔、照片、影片、音樂、和其他素材等
                                        (以下簡稱內容)，應保證未違反第三方版權、專利權、商標權、營業秘密等智慧財產權權益，以免涉及侵權或違法之責任。除非您已獲得內容所有人的同意或授權您有權發佈該內容並授予本網站、本服務的使用許可。
                                    </li>
                                    <li>2.
                                        若本公司在得到有關會員所上傳的內容侵犯他人的版權或智慧財產權的適當通知後，本公司將刪除所有相關內容。本公司保留未事先通知而刪除內容的權利。若經本公司告知相關侵權行為，而您未加以理會，本公司
                ...
                <label class="uploadIcon">
                    <i class="icon-upload"></i>上傳商品附圖
                    <input id="fileupload" type="file" name="files[]" accept="image/*" multiple>
                </label>
            </section>
            <section class="sectionPreview">
                <div class="sectionTitle">
                    <h5><i class="icon-subTitle"></i>已上傳附圖如下，若您不想要某個商品附圖，則點選 x 刪除。</h5>
                </div>
                <div id="previewBox" class="sectionContent"></div>
            </section>
            <input id="next" type="button" onclick="fileFormData.startUpload()">
        </form>
