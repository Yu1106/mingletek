		...
		<div class="wrapper">
			...
			<main>
				...
				<div class="seller-board">
					<div class="seller-board-title">MINGLETEK</div>
					...
					<div class="intro-section-right">
						...
						<div class="item-desc">
							...
							<div class="row">
								...
								<label class="row-value price">$1,380</label>
							...
							<div class="row">
								...
								<label class="row-value">全新</label>
							</div>
							<div class="item-purchase">
								...
								<div class="item-purchase-row">
									<label for="" class="aTag mr-15">
										<img src="images/pchome/heart-icon.gif" alt="">
										加入追蹤
									</label>
									<label for="" class="aTag mr-15">
										<img src="images/pchome/chat-icon.gif" alt="">
										留言板(0)
									</label>
								</div>
							</div>
